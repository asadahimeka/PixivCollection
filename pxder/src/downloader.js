...
async function downloadByBookmark(me, isPrivate = false) {
  ...
  Fse.ensureFileSync(lastIllustsPath)
  const lastIllusts = Fse.readJSONSync(lastIllustsPath, { throws: false }) || []
  ...
  Fse.ensureFileSync(lastIdPath)
  const lastIllust = Fse.readJSONSync(lastIdPath, { throws: false }) || { id: '' }
  console.log('Last Illust Id: ', lastIllust.id)
